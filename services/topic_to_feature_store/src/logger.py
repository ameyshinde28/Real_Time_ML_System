...
def elasticsearch_sink(message):
    ...
    # extra_params = message.record["extra"]
    # extra_params = record.get("extra", {})  # Use .get() with default empty dict
    ...
    es.index(index="feature_pipeline-topic_to_feature_store", body=json.dumps(log_entry))
